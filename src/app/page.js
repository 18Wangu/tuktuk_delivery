    ...
    <div className="bg-[#F8F9E9]">
      <div className="px-5">
        ...
        <div>
          ...
          {/* 1st resto */}
          <div className="flex justify-between items-center border-black rounded-lg my-2">
            <div className="flex">
              <div>
                <Image
                  src="/pad-thai.jpg"
            ...
            <div className="text-white bg-black rounded-3xl py-1 px-3 h-max">Buy</div>
          </div>
          {/* 2nd resto */}
          <div className="flex justify-between items-center border-black rounded-lg my-2">
            <div className="flex">
          ...
          {/* 7th resto */}
          <div className="flex justify-between items-center border-black rounded-lg my-2 mb-16">
            <div className="flex">
              <div>
                <Image
